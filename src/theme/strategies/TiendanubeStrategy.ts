/**
 * Strategy Pattern - Tiendanube Theme Strategy
 *
 * Estilo: Balanceado, PYME, profesional
 * Características:
 * - Usa CSS variables del tema
 * - Bordes redondeados (rounded-lg)
 * - Balance entre funcionalidad y estética
 * - Tipografía semibold/bold
 */

import type { ThemeStrategy } from "./ThemeStrategy";

export const TiendanubeStrategy: ThemeStrategy = {
  name: "tiendanube",
